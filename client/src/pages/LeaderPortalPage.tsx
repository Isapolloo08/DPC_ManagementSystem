...
import { LeaderMembers } from "./leader/LeaderMembers";
import { LeaderBibleStudy } from "./leader/LeaderBibleStudy";

export const LeaderPortalPage: React.FC = () => {
  const { user, selectedMinistryId } = useAuth();

  // Active sub-view: "dashboard" | "members" | "biblestudy"
  const [activeTab, setActiveTab] = useState<"dashboard" | "members" | "biblestudy">("dashboard");
...
export default LeaderPortalPage;
